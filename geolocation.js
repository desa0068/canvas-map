...
function reportPosition( position ){ 
    ...
    var link="http://maps.google.com/maps/api/staticmap?zoom=14&size=400x400&maptype=terrain&sensor=true&markers=size:mid%7Ccolor:red%7C"+ position.coords.latitude + ',' + position.coords.longitude;
